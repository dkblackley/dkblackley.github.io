...
When we discuss these operations on AES we use some specific notation. We split our 128 bit plaintext into a set of 32 bit "words":

And all of the bytes of the plaintext is stored and represented by a matrix that we call the state array:
